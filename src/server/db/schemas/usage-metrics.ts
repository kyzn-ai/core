 ...
 */
export const usageMetricEvents = ["message", "sms"] as const

/**
 * @description The source of a usage metric.
 */
export type UsageMetricEvent = typeof usageMetricEvents
 ...
 */
export type UsageMetricUnit = typeof usageMetricUnits
