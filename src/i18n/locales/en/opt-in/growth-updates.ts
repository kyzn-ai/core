...
export const growthUpdates = {
    ...
    complete: "You’re locked in! I’ll send you an invite when KYZN is ready. That’s all for now.",
    unsubscribe: "Opt-out successful. You will no longer receive updates from KYZN.",
    resubscribe: "You have previously unsubscribed from updates from KYZN. If you would like to opt back in, please reply with “YES” to confirm."
}
